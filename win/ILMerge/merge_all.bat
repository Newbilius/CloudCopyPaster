...
rem        del  %target_dir%*.*
rem        del  %target_dir%*.dll
rem        del  %target_dir%*.pdb
rem        del  %target_dir%*.xml
rem        del  %target_dir%*.*
rem        
rem        copy %result% %target_dir%
rem        rmdir /S /Q %outdir%
rem        set result=%target_path% 
rem        @echo Result: %target_file% "->  %target_path%"
    ) ELSE (
